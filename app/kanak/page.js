...
const kanak = () => {
  return (
    <div className="kanak_portfolio">
      <section className="about-crev section-padding position-relative">
            ...
            <div className="col-lg-6">
              <div className="left-block mt-100 md-mb50">
                <div className="d-flex align-items-center">
                  <div>
                    <div className="info">
                      <h3 className=" main-color fz-50 line-height-1">01</h3>
                      <p className="nowrap">
                        Years of
                        <br /> Experience
                      </p>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="d-flex align-items-center mb-20">
                        ...
                        <div className="ml-20">
                          <p className="fz-14">Kanak Bisht</p>
                        </div>
                      </div>
                      <div className="d-flex align-items-center">
                        <div>
                    ...
                    <div className="col-md-6">
                      <div className="d-flex align-items-center mb-20">
                        ...
                        <div className="ml-20">
                          <p className="fz-14">+91 878784 83437</p>
                        </div>
                      </div>
                      <div className="d-flex align-items-center">
                        <div>
